(function(l){typeof define=="function"&&define.amd?define(l):l()})(function(){"use strict";var l=typeof document<"u"?document.currentScript:null;function b(){const e=document.createElement("style");document.head.appendChild(e),e.innerHTML=`
    ...
    <br>`,t.appendChild(o),e.appendChild(t),n.addEventListener("click",()=>{localStorage.setItem("popup","off"),e.style.display="none"})}function w(){const e=document.createElement("div");e.id="rsam-pulse",e.style.display="none",e.innerHTML='<div class="ringring"></div><div class="circle"></div>',document.body.appendChild(e);let t=!1;e.addEventListener("mousedown",function(o){var a=o.clientX-parseInt(window.getComputedStyle(this).left),s=o.clientY-parseInt(window.getComputedStyle(this).top);function p(u){t=!0,e.style.left=u.clientX-a+"px",e.style.top=u.clientY-s+"px"}function c(){setTimeout(()=>{t=!1},2e3),window.removeEventListener("mousemove",p),window.removeEventListener("mouseup",c)}window.addEventListener("mousemove",p),window.addEventListener("mouseup",c)});let n=0,i=null;e.addEventListener("click",function(){n++,!i&&(i=setTimeout(()=>{if(n===1){if(!t){const o=document.getElementById("rsam-popup");o&&(o.style.display="flex",localStorage.setItem("popup","on"))}}else e.style.left=`${window.innerWidth-70}px`,e.style.top="0px";n=0,i=null},200))})}let m=0,f=0,g=0,y=0,x=0;function E({kubahBd:e,kubahBdMax:t,bebeng:n,boyong:i,krasak:o}){let a=!1;if(n[1]>20&&n[1]>m){a=!0,m=n[1];const s=document.getElementById("bebeng-message");s.innerHTML=`Terjadi RF/AP di Sungai Bebeng (Suhu ${n[1]}&deg;) <br> <span style="font-size:12px;font-weight:normal">${n[0]}</span>`}if(i[1]>20&&i[1]>f){a=!0,f=i[1];const s=document.getElementById("boyong-message");s.innerHTML=`Terjadi RF/AP di Sungai Boyong (Suhu ${i[1]}&deg;) <br> <span style="font-size:12px;font-weight:normal">${i[0]}</span>`}if(o[1]>20&&o[1]>g){a=!0,g=o[1];const s=document.getElementById("krasak-message");s.innerHTML=`Terjadi RF/AP di Sungai Krasak (Suhu ${o[1]}&deg;) <br> <span style="font-size:12px;font-weight:normal">${o[0]}</span>`}if(e[1]>20&&e[1]>y||t[1]>100&&t[1]>x){a=!0,y=e[1],x=t[1];const s=document.getElementById("kubah-message");s.innerHTML=`Peningkatan suhu kubah BD <br> (Suhu Avg ${e[1]}&deg;, Suhu Max ${t[1]}&deg;) <br> <span style="font-size:12px;font-weight:normal">${t[0]}</span>`}if(a){const s=document.getElementById("rsam-popup"),p=document.getElementById("rsam-pulse");p.style.display="block",localStorage.getItem("popup")!=="off"&&(s.style.display="flex")}}b(),v(),w();let d=0,r="";const L=new URL(typeof document>"u"&&typeof location>"u"?require("url").pathToFileURL(__filename).href:typeof document>"u"?location.href:l&&l.src||new URL("bpptkg-notify.umd.js",document.baseURI).href).searchParams.get("url"),k=new EventSource(`${atob(L)}/notify`);k.onmessage=function(e){const{mepas:t,date:n,alertType:i,kubahBd:o,kubahBdMax:a,bebeng:s,boyong:p,krasak:c}=JSON.parse(e.data),u=document.getElementById("rsam-popup"),h=document.getElementById("rsam-pulse"),S=document.getElementById("rsam-popup-message");u&&h&&(E({kubahBd:o,kubahBdMax:a,bebeng:s,boyong:p,krasak:c}),i?(r||(r=n),t>d&&(d=t),h.style.display="block",localStorage.getItem("popup")!=="off"&&(u.style.display="flex"),S.innerHTML=i===1?`Nilai RSAM ${d} <br> Waspadai APG > 1KM <br> <span style="font-size:12px;font-weight:normal">${r}</span>`:`Nilai RSAM ${d} <br>Terjadi Gempa VT Kuat <br> <span style="font-size:12px;font-weight:normal">${r}</span>`):(d=0,r="",localStorage.setItem("popup","on")))}});
